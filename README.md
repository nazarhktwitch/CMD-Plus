...
16) Downloads a file from a specified URL to a specified destination: 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐡𝐭𝐭𝐩𝐬://𝐞𝐱𝐚𝐦𝐩𝐥𝐞.𝐜𝐨𝐦/𝐟𝐢𝐥𝐞.𝐳𝐢𝐩 𝐲𝐨𝐮𝐫\𝐩𝐚𝐭𝐡\𝐡𝐞𝐫𝐞 (When an error is received [Errno 13] Permission denied try to start program by administrator) (ONLY FOR V0.21+ USERS ONLY!)
